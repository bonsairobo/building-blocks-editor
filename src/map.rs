use crate::{
    voxel::{EMPTY_SIGNED_DISTANCE, EMPTY_VOXEL_TYPE},
    ThreadLocalResourceHandle, VoxelType, VoxelTypeInfo,
};
...
pub const CHUNK_SHAPE: Point3i = PointN([16; 3]);
